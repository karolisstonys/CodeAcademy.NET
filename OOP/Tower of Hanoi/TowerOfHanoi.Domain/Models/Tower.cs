...
namespace TowerOfHanoi.Domain.Models
{
    public class Tower
    {
        ...
        public string[] Peg1 { get; set; } = { EDisks.Disk1, EDisks.Disk2, EDisks.Disk3, EDisks.Disk4 };
        public string[] Peg2 { get; set; } = { EDisks.Empty, EDisks.Empty, EDisks.Empty, EDisks.Empty };
        public string[] Peg3 { get; set; } = { EDisks.Empty, EDisks.Empty, EDisks.Empty, EDisks.Empty };
