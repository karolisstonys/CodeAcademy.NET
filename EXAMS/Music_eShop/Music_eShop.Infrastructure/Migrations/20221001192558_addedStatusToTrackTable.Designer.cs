...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Music_eShop.Domain.Models.Album", b =>
                {
            ...
            modelBuilder.Entity("Music_eShop.Domain.Models.Artist", b =>
                {
                    b.Property<long>("ArtistId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Music_eShop.Domain.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("Music_eShop.Domain.Models.Employee", b =>
                {
            ...
            modelBuilder.Entity("Music_eShop.Domain.Models.Genre", b =>
                {
            ...
            modelBuilder.Entity("Music_eShop.Domain.Models.Invoice", b =>
                {
            ...
            modelBuilder.Entity("Music_eShop.Domain.Models.InvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("Music_eShop.Domain.Models.MediaType", b =>
                {
            ...
            modelBuilder.Entity("Music_eShop.Domain.Models.Playlist", b =>
                {
            ...
            modelBuilder.Entity("Music_eShop.Domain.Models.Track", b =>
                {
                    b.Property<long>("TrackId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Music_eShop.Domain.Models.Album", b =>
                {
                    b.HasOne("Music_eShop.Domain.Models.Artist", "Artist")
                        .WithMany("Albums")
            ...
            modelBuilder.Entity("Music_eShop.Domain.Models.Customer", b =>
                {
                    b.HasOne("Music_eShop.Domain.Models.Employee", "SupportRep")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("Music_eShop.Domain.Models.Employee", b =>
                {
                    b.HasOne("Music_eShop.Domain.Models.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("Music_eShop.Domain.Models.Invoice", b =>
                {
                    b.HasOne("Music_eShop.Domain.Models.Customer", "Customer")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("Music_eShop.Domain.Models.InvoiceItem", b =>
                {
                    b.HasOne("Music_eShop.Domain.Models.Invoice", "Invoice")
                        .WithMany("InvoiceItems")
                        .HasForeignKey("InvoiceId")
                        .IsRequired();

                    b.HasOne("Music_eShop.Domain.Models.Track", "Track")
                        .WithMany("InvoiceItems")
            ...
            modelBuilder.Entity("Music_eShop.Domain.Models.Track", b =>
                {
                    b.HasOne("Music_eShop.Domain.Models.Album", "Album")
                        .WithMany("Tracks")
                        .HasForeignKey("AlbumId");

                    b.HasOne("Music_eShop.Domain.Models.Genre", "Genre")
                        .WithMany("Tracks")
                        .HasForeignKey("GenreId");

                    b.HasOne("Music_eShop.Domain.Models.MediaType", "MediaType")
                        .WithMany("Tracks")
            ...
            modelBuilder.Entity("PlaylistTrack", b =>
                {
                    b.HasOne("Music_eShop.Domain.Models.Playlist", null)
                        .WithMany()
                        .HasForeignKey("PlaylistId")
                        .IsRequired();

                    b.HasOne("Music_eShop.Domain.Models.Track", null)
                        .WithMany()
                        .HasForeignKey("TrackId")
                        .IsRequired();
                });
