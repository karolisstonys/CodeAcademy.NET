...
namespace L04EFApplyingToAPI.Migrations
{
    ...
    [Migration("20221221162156_updatedSpiceLevelToOptional")]
    partial class updatedSpiceLevelToOptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("L04_EF_Applying_To_API.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuania",
                            CreatedDateTime = new DateTime(2022, 12, 21, 18, 21, 56, 691, DateTimeKind.Local).AddTicks(5799),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuania",
                            CreatedDateTime = new DateTime(2022, 12, 21, 18, 21, 56, 691, DateTimeKind.Local).AddTicks(6042),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuania",
                            CreatedDateTime = new DateTime(2022, 12, 21, 18, 21, 56, 691, DateTimeKind.Local).AddTicks(6046),
                            ImagePath = "",
                            Name = "Kibinai",
                            SpiceLevel = "Low",
                            Type = "Street food",
            ...
            modelBuilder.Entity("L04_EF_Applying_To_API.Models.DishOrder", b =>
                {
            ...
            modelBuilder.Entity("L04_EF_Applying_To_API.Models.DishOrder", b =>
                {
                    ...
                    b.HasOne("L04_EF_Applying_To_API.Models.LocalUser", "LocalUser")
                        .WithMany("DishOrders")
