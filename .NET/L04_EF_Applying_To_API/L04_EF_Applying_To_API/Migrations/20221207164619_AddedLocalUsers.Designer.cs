...
namespace L04EFApplyingToAPI.Migrations
{
    ...
    [Migration("20221207164619_AddedLocalUsers")]
    partial class AddedLocalUsers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("L04_EF_Applying_To_API.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuania",
                            CreatedDateTime = new DateTime(2022, 12, 7, 18, 46, 18, 860, DateTimeKind.Local).AddTicks(238),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuania",
                            CreatedDateTime = new DateTime(2022, 12, 7, 18, 46, 18, 860, DateTimeKind.Local).AddTicks(278),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuania",
                            CreatedDateTime = new DateTime(2022, 12, 7, 18, 46, 18, 860, DateTimeKind.Local).AddTicks(280),
                            ImagePath = "",
                            Name = "Kibinai",
                            SpiceLevel = "Low",
                            Type = "Street food",
