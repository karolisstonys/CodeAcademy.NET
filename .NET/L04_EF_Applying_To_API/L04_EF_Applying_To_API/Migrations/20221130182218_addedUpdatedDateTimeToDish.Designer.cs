...
namespace L04EFApplyingToAPI.Migrations
{
    ...
    [Migration("20221130182218_addedUpdatedDateTimeToDish")]
    partial class addedUpdatedDateTimeToDish
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("L04_EF_Applying_To_API.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuania",
                            CreatedDateTime = new DateTime(2022, 11, 30, 20, 22, 18, 514, DateTimeKind.Local).AddTicks(8497),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuania",
                            CreatedDateTime = new DateTime(2022, 11, 30, 20, 22, 18, 514, DateTimeKind.Local).AddTicks(8534),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuania",
                            CreatedDateTime = new DateTime(2022, 11, 30, 20, 22, 18, 514, DateTimeKind.Local).AddTicks(8536),
                            ImagePath = "",
                            Name = "Kibinai",
                            SpiceLevel = "Low",
                            Type = "Street food",
