...
namespace L04EFApplyingToAPI.Migrations
{
    ...
    [Migration("20221215165612_AddedDishOrder")]
    partial class AddedDishOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("L04_EF_Applying_To_API.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuania",
                            CreatedDateTime = new DateTime(2022, 12, 15, 18, 56, 12, 477, DateTimeKind.Local).AddTicks(2747),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuania",
                            CreatedDateTime = new DateTime(2022, 12, 15, 18, 56, 12, 477, DateTimeKind.Local).AddTicks(2792),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuania",
                            CreatedDateTime = new DateTime(2022, 12, 15, 18, 56, 12, 477, DateTimeKind.Local).AddTicks(2795),
                            ImagePath = "",
                            Name = "Kibinai",
                            SpiceLevel = "Low",
                            Type = "Street food",
